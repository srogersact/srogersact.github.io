...
window.addEventListener("load", e => {
    ...
    for (var i = 0; i < numYouTryAnalysisDivs; ++i) {
        ...
        prompt.innerHTML = `<b>Use what you know about <u>past participles</u> to make this sentence into two sentences:</b> <br> ${analysis_problems[i].composedSentence}`;
    ...
    for (var i = 0; i < numYouTryCompositionDivs; ++i) {
        ...
        var prompt = document.createElement('p');
        prompt.innerHTML = `<b>Use what you know about <u>past participles</u> to make these two sentences into one sentence: </b> <br>${composition_problems[i].analyzedSentence}`;
