...
window.addEventListener("load", e => {
    ...
    for (var i = 0; i < numYouTryAnalysisDivs; ++i) {
        ...
        prompt.innerHTML = `<b>Make one change.</b> <br>${analysis_problems[i].composedSentence}`;
        ...
        submitButton.addEventListener("click", e => {
            ...
            feedbackElement.innerHTML = `Oops! Do you need to add a comma or a period or capitals?`;
            feedbackElement.style.color = 'red';
    ...
    for (var i = 0; i < numYouTryCompositionDivs; ++i) {
        ...
        submitButton.addEventListener("click", e => {
            ...
            // check: in all other cases, prompt them to try again.
            feedbackElement.innerHTML = `Oops! Do you need a comma, a period, capitals, an apostrophe, or quotation marks?`;
            feedbackElement.style.color = 'red';
